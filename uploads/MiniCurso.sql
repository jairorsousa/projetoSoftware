...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Out-2015 às 15:08
...
CREATE TABLE IF NOT EXISTS `inscr_trabalho` (
  `codigo_inscricao` smallint(6) NOT NULL,
  `codigo_trabalho` smallint(6) NOT NULL,
...
INSERT INTO `pessoas` (`codigo`, `nome`, `cpf`, `email`, `curriculo`, `telefone`, `nivel`, `senha`) VALUES
(1, 'Jairo Rodrigues', '01076601219', 'jairorodrigues.sousa@gmail.com', NULL, NULL, '5', '123');
